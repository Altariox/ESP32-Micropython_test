...
class LcdApi:
    ...
    LCD_ENTRY_MODE=0x04; LCD_ENTRY_INC=0x02; LCD_ENTRY_SHIFT=0x01
    LCD_ON_CTRL=0x08; LCD_ON_DISPLAY=0x04; LCD_ON_CURSOR=0x02; LCD_ON_BLINK=0x01
    LCD_MOVE=0x10; LCD_MOVE_DISP=0x08; LCD_MOVE_RIGHT=0x04
    LCD_FUNCTION=0x20; LCD_FUNCTION_8BIT=0x10; LCD_FUNCTION_2LINES=0x08; LCD_FUNCTION_10DOTS=0x04; LCD_FUNCTION_RESET=0x30
    LCD_CGRAM=0x40; LCD_DDRAM=0x80
